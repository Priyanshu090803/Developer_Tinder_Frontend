...
//       >
//         {/* Card Container */}
//         <div className="relative h-[90%] w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-amber-100 transition-all duration-500 hover:shadow-2xl pb-4">
//           {/* Decorative elements */}
...
//           {/* Content */}
//           <div className="px-5 py-2 space-y-2  flex-wrap  flex-col">
...
//               className=" cursor-pointer flex-3 bg-gradient-to-r from-amber-400 to-rose-400 hover:from-amber-500 hover:to-rose-500 text-white py-1  rounded-full transition-all duration-300 shadow-lg hover:shadow-xl">
//                 Interested
//               </button>
//               <button 
//               onClick={()=>handleSendRequest("rejected",user._id)}
              
//               className=" cursor-pointer flex-3 border-2 border-amber-300 text-amber-700 hover:bg-amber-50 py-1  rounded-full transition-all duration-300">
//                Ignore
//               </button>
//             </div>
//           </div>
